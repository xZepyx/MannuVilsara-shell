...
BentoCard {
    ...
    property var quotes: [
        { text: "My code doesn't work, I have no idea why. My code works, I have no idea why.", author: "Every Programmer" },
        { text: "Hardware: The parts of a computer system that can be kicked.", author: "Jeff Pesis" },
        ...
        { text: "It works on my machine.", author: "Unknown" },
        { text: "A computer once beat me at chess, but it was no match for me at kick boxing.", author: "Emo Philips" },
        { text: "I checked the logs, it says 'Error: Succeeded'.", author: "Anonymous" }
    ]
